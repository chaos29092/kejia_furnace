...
@section('title')
    {{Lang::get('meta.mailok_title')}} - Kejia
@stop
                    ...
                    <div class="vc_col-sm-12 wpb_column column_container" style="" data-animation="" data-delay="0">
                        <div class="wpb_wrapper">
                            <div class="wpb_content_element dynamic_page_header style_2">
                                <h1 style="font-size:36px; font-family:Bebas Neue; color:#303030">{{Lang::get('page.thank_you')}}!</h1>
                                <p class="description">{{Lang::get('page.received_1')}} <br>
                                    {{Lang::get('page.received_2')}}</p>
                                {{--<p>If you would like immediate assistance, please call us Monday - Friday(9:00-5:00 Eastern) at (603)756-9401</p>--}}
                                        ...
                                        <div class="accordion faq style_1" id="accordion759">
                                            ...
                                            <div class="accordion-group payment">
                                                ...
                                                <div id="toggle21978" class="accordion-body  collapse ">
                                                    <div class="accordion-inner">{{Lang::get('page.methods_transportation')}}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion-group payment">
                                                ...
                                                <div id="toggle43155" class="accordion-body  collapse ">
                                                    <div class="accordion-inner">{{Lang::get('page.warranty')}}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
